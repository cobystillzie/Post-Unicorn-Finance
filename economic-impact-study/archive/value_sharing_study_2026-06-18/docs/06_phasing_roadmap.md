...
the thesis owner. This keeps an ambitious, multi-week study honest and fundable one defensible step at a time.

---

## Phase 0 — Scoping + pilot (source dated 2026-06-17; reconciled 2026-06-18)

**Goal:** give the thesis owner something concrete to understand and greenlight.

Deliverables:
- [x] Scoping brief (`00_scoping_brief.md`)
- [x] Comparison methodology / fairness engine (`01_comparison_methodology.md`)
- [x] Mechanism catalog, broad + deep, source-cited (`02_mechanism_catalog.md`)
- [x] Graded evidence synthesis (`03_evidence_synthesis.md`)
- [x] Data strategy + provider × cost matrix (`04_data_strategy.md`)
- [x] Thesis-owner questions (`05_questions_for_ethan.md`)
- [x] Pilot 31-company retained dataset (15 post-unicorn / 16 VC-backed) (`data/pilot_companies.csv`) + first cuts (`analysis/pilot_first_cuts.md`)
- [x] One-page visual (`visuals/`)

The retained Phase 0 pilot is **31 companies**, not a completed 20-company-versus-20-company comparison. The earlier
equal-sized comparison language was a target shape; the actual retained set is 15 post-unicorn and 16 VC-backed rows
after verification.

**Gate to Phase 1:** the thesis owner confirms the thesis framing, the fairness basis, and the public-first/licensed-later
...
- Expand the matched sample well beyond the retained 31-company Phase 0 pilot, still matched on sector + country.
